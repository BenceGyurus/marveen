...
window._i18n.en = {
  ...
  'agents.claude_md_generating':			'Generating Agent Instructions...',
  ...
  'agents.wizard.generating_status': 'Generating Instructions...',
  ...
  'agents.settings.memory_isolation_desc':   'When enabled, the agent starts with its own, initially empty file memory and no longer sees the shared MEMORY.md. Shared SQLite memories and instructions still reach it. Recommended on multi-user installs; leave it off on single-operator installs. Takes effect on the next restart.',
  ...
  'agents.claude_md_saved':        'Instructions saved',
